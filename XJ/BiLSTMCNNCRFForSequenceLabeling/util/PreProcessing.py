...
def readEmbeddings(embeddingsPath, datasetFiles, 
    ...
    if frequencyThresholdUnknownTokens is not None and frequencyThresholdUnknownTokens >= 0:
        fd = nltk.FreqDist()
...
def getLevyDependencyEmbeddings():
    if not os.path.isfile("levy_deps.words.bz2"):
        ...
        os.system("wget -O levy_deps.words.bz2 http://u.cs.biu.ac.il/~yogo/DataForModelTraining/syntemb/deps.words.bz2")
